...
function createNote(){
    ...
    node1.setAttribute("style","width:250px; height:250px; font-size:26px; padding:25px; margin-top10px, overfow:hidden; box-shadow:0px 10px 24px 0px rgba(0,0,0,0.75)");
